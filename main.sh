...
DEBIAN_SKIPPED_TAGS="debian:(rc-|[6789]|(.*([0-9]+\.[0-9]+|[0-9]{8}|(oldoldstable|buster)-backports|buggy|experimental|stretch|jessie|squeeze|wheezy).*))"
SKIPPED_TAGS="$DEBIAN_SKIPPED_TAGS"
